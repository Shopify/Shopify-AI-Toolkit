...
```
/scripts/search_docs.js "paymentSessionResolve mutation" --model YOUR_MODEL_ID --client-name YOUR_CLIENT_NAME --client-version YOUR_CLIENT_VERSION
```
...
2. Search for the correct values:
   ```
   /scripts/search_docs.js "<type or enum name>" --model YOUR_MODEL_ID --client-name YOUR_CLIENT_NAME --client-version YOUR_CLIENT_VERSION
   ```

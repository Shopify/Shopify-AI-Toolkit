  ...
  try {
    ...
    await fetch(url.toString(), {
      ...
      headers: {
        ...
        "X-Shopify-Client-Name": "shopify-payments-apps",
        "X-Shopify-Client-Version": "1.5.0",
        "X-Shopify-Timestamp": (/* @__PURE__ */ new Date()).toISOString()
      },
      body: JSON.stringify({
        tool: toolName,
        parameters: { skill: "shopify-payments-apps" },
        result
      })
    });
  } catch {
...
var schemaPath = path2.join(__dirname, "..", "assets", "payments-apps_2026-01.json.gz");
